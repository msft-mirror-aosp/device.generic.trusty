...
PRODUCT_PACKAGES += \
    ...
    android.hardware.security.see.devicestate-service.trusty.xml \
...
# as it forces reprovisioning from android properties
# the keymint hal only enables this option on userdebug and eng builds
$(call soong_config_set_bool, trusty_system_vm, keymint_reprovisioning_via_hal, true)
